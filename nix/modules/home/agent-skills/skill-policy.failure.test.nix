...
let
  ...
  sourceRoot = repoRoot + "/nix/modules/home/agent-skills";
  fm =
  ...
  cases = {
    ...
    duplicateSkillDefinition = {
      expression = policy.mergeSkillDefinitions { demo.root = sourceRoot; } { demo.root = sourceRoot; };
      expectedFragment = "agent skills cannot be both external and local: demo";
    };
  };
in
