...
pub fn validate_sri_hash(label: &str, hash: &str) -> Result<(), UpdateError> {
...
pub fn validate_https_url(label: &str, url: &str) -> Result<(), UpdateError> {
    let authority = url
        .strip_prefix("https://")
...
#[cfg(test)]
mod tests {
    use super::{paired_input_version, validate_https_url, validate_sri_hash};
