...
let
  ...
  entries = {
    "${username}@linux-x86_64" = standalone entityContexts.linuxX86.home.linux;
    "${username}@linux-aarch64" = standalone entityContexts.linuxAarch64.home.linux;
    "${username}@wsl-x86_64" = standalone entityContexts.linuxX86.home.wsl;
    "${username}@wsl-aarch64" = standalone entityContexts.linuxAarch64.home.wsl;
    wsl = integratedWsl entityContexts.linuxX86;
    wsl-aarch64 = integratedWsl entityContexts.linuxAarch64;
