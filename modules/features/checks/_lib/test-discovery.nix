...
in
{
  ...
  classify =
    ...
    let
      ...
      moduleSuiteFiles = builtins.filter (path: lib.hasSuffix moduleSuiteSuffix (baseNameOf path)) files;
    ...
    in
    {
      inherit moduleSuiteFiles failureTestFiles testFiles;
    };
