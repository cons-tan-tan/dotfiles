...
let
  ...
  harness = import (repoRoot + "/modules/features/checks/_lib/eval/module-suite-harness.nix") {
    ciCheck = { };
    inputs = { };
  ...
  fixture = {
    meta = {
      checkName = "fixture-module-suite-tests";
      execution = "build";
  ...
  cases = {
    ...
    invalidMetadata = {
      ...
      expectedFragment = "has invalid Module suite metadata";
    };
    emptyPositiveTests = {
    ...
    duplicateSuitePath = {
      ...
      expectedFragment = "Module suite paths must be unique";
    };
    duplicateSuiteCheckName = {
      ...
      expectedFragment = "Module suite check names must be unique";
    };
  };
in
