let
  pin = builtins.fromJSON (builtins.readFile ../../../../../nix/pins/shellfirm.json);
  manifest = fromTOML (builtins.readFile ../../../../../nix/packages/agent-command-guard/Cargo.toml);
  lock = fromTOML (builtins.readFile ../../../../../nix/packages/agent-command-guard/Cargo.lock);
