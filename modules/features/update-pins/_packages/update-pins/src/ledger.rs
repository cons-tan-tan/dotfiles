...
fn record_paired_version(
    ...
    if old != new {
        ...
        represented.insert(path);
        represented.insert(source.authority.generated_flake_path);
    }
}
...
mod tests {
    ...
    fn malformed_candidate_falls_back_to_a_managed_file_change() {
        ...
        let before = [super::FileState {
            path: "modules/features/agents/herdr/_packages/herdr/pin.json",
        ...
        assert_eq!(
            ...
            [change(
                Target::Herdr,
                ChangeKind::ManagedFile(
                    "modules/features/agents/herdr/_packages/herdr/pin.json".into()
                )
            )]
        );
    }
  ...
  url = "github:aannoo/hcom/v1.0.0";
            ...
            state(
                "flake.nix",
                br#"inputs.hcom-src.url = "github:aannoo/hcom/v1.0.0";"#,
            ),
  ...
  url = "github:aannoo/hcom/v2.0.0";
            ...
            state(
                "flake.nix",
                br#"inputs.hcom-src.url = "github:aannoo/hcom/v2.0.0";"#,
            ),
        ...
        let herdr_before = [state(
            "modules/features/agents/herdr/_packages/herdr/pin.json",
        ...
        assert_eq!(
            ...
            [
                ...
                ChangeKind::SourceHash,
                ChangeKind::Lockfile(
                    "modules/features/agents/base/_packages/shellfirm/Cargo.lock".to_owned(),
                ),
            ]
        );
        ...
        let schema_before = [state(
            "modules/features/agents/claude/_pins/settings-schema.json",
        ...
        let codex_before = [state(
            "modules/features/agents/codex/_packages/codex-app/pin.json",
    ...
    fn published_node_diff_attributes_pin_and_shared_input_to_difit() {
        ...
        let before = [
            state(
                "modules/features/agents/difit/_packages/difit/pin.json",
                br#"{"srcHash":"sha256-old","pnpmDepsHash":"sha256-old"}"#,
            ),
            state(
                "modules/features/agents/difit/default.nix",
  ...
  url = "github:yoshiko-pg/difit/v1.0.0";
            ...
            state(
                "flake.nix",
                br#"inputs.difit-src.url = "github:yoshiko-pg/difit/v1.0.0";"#,
            ),
            state("flake.lock", br#"{"nodes":{"old":{}}}"#),
        ];
        let after = [
  ...
  url = "github:yoshiko-pg/difit/v2.0.0";
            ...
            state(
                "flake.nix",
                br#"inputs.difit-src.url = "github:yoshiko-pg/difit/v2.0.0";"#,
            ),
            state("flake.lock", br#"{"nodes":{"new":{}}}"#),
        ];
