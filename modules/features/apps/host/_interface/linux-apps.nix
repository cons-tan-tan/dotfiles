...
let
  ...
  nhCleanupSystemd = pkgs.callPackage nhCleanupSystemdSource {
  ...
  buildScript = pkgs.writeShellApplication {
    ...
    text = ''
      ...
      ${builtins.readFile ../_scripts/linux-host-build.sh}
    '';
  };
  ...
  switchScript = pkgs.writeShellApplication {
    ...
    text = ''
      ...
      ${builtins.readFile ../_scripts/linux-host-switch.sh}
    '';
  };
  ...
  applyWingetScript = pkgs.writeShellApplication {
    ...
    text = ''
      ...
      ${builtins.readFile ../_scripts/apply-winget.sh}
    '';
  };
in
appSet.mkAppSet {
